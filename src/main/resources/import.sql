INSERT INTO usuarios (fecha_nacimiento, id_usuario, apellidos, cedula, celular, contrasena, direccion, foto_path, mail, nombre_usuario, nombres) VALUES ('1992-04-24 00:00:00', 1, 'Idrovo', '0104455647', '0984359326', 'Giant424$', 'Av Loja', 'demosslay[1].jpg',  'juancidrovo@gmail.com', 'juanc .i.', 'Juan');
INSERT INTO usuarios (fecha_nacimiento, id_usuario, apellidos, cedula, celular, contrasena, direccion, foto_path, mail, nombre_usuario, nombres) VALUES ('1985-05-20 00:00:00', 2, 'Perez', '0202020202', '0888888888', 'password456', 'Avenida Siempre Viva 742', 'nezuco[1].jpg', 'email2@example.com', 'usuario2', 'Maria');
INSERT INTO usuarios (fecha_nacimiento, id_usuario, apellidos, cedula, celular, contrasena, direccion, foto_path, mail, nombre_usuario, nombres) VALUES ('1992-09-15 00:00:00', 3, 'Lopez', '0303030303', '0777777777', 'password789', 'Calle 8', 'goku-black-32[1].jpg','email3@example.com', 'usuario3', 'Carlos');
INSERT INTO usuarios (fecha_nacimiento, id_usuario, apellidos, cedula, celular, contrasena, direccion, foto_path, mail, nombre_usuario, nombres) VALUES ('1980-12-01 00:00:00', 4, 'Martinez', '0404040404', '0666666666', 'password012', 'Carrera 7', 'nami.jpeg', 'email4@example.com', 'usuario4', 'Laura');
INSERT INTO usuarios (fecha_nacimiento, id_usuario, apellidos, cedula, celular, contrasena, direccion, foto_path, mail, nombre_usuario, nombres) VALUES ('1995-07-30 00:00:00', 5, 'Rodriguez', '0505050505', '0555555555', 'password345', 'Plaza Mayor 1', "gojo[1].jpg", 'Viajes, Tecnología', 'usuario5', 'Pedro');
...
INSERT INTO tipospuntosinteres (idtipospuntosinteres, descripcion, nombre, categoria) VALUES (4, 'Iglesias y Catedrales en Cuenca', 'Iglesias y Catedrales', 'Iglesias');
...
INSERT INTO foto (fotoid, foto) VALUES (2, 'https://practicasjohnsiguenza.s3.us-east-2.amazonaws.com/turi.jpg');
INSERT INTO foto (fotoid, foto) VALUES (3, 'https://practicasjohnsiguenza.s3.us-east-2.amazonaws.com/columpioturi.jpeg');
INSERT INTO foto (fotoid, foto) VALUES (4, 'https://practicasjohnsiguenza.s3.us-east-2.amazonaws.com/igleasiaSagrario.jpg');
INSERT INTO foto (fotoid, foto) VALUES (5, 'https://practicasjohnsiguenza.s3.us-east-2.amazonaws.com/La-toreadora.jpg');
INSERT INTO foto (fotoid, foto) VALUES (6, 'https://practicasjohnsiguenza.s3.us-east-2.amazonaws.com/paqDragon.jpg');


INSERT INTO administradores (id_administrador, apellidos, cedula, celular, contrasenia, email, nombre_usuario, nombres, url_imagen) VALUES (1, 'Lupercio', '0606060606', '0987456325', 'esteban45', 'esteban@gmail.com', 'esteban12', 'Esteban', "https://practicasjohnsiguenza.s3.us-east-2.amazonaws.com/spiderman.jpg");
INSERT INTO administradores (id_administrador, apellidos, cedula, celular, contrasenia, email, nombre_usuario, nombres, url_imagen) VALUES (2, 'Cardenas', '0707070707', '0945210361', 'xavier23', 'xavi@hotmail.com', 'xavi45', 'Xavier', "https://practicasjohnsiguenza.s3.us-east-2.amazonaws.com/goku-black-32%5B1%5D.jpg");
INSERT INTO administradores (id_administrador, apellidos, cedula, celular, contrasenia, email, nombre_usuario, nombres, url_imagen) VALUES (3, 'Balarezo', '0808080808', '0987412569', 'caro69', 'carolina@hotmail.com', 'dani5', 'Carolina', "https://practicasjohnsiguenza.s3.us-east-2.amazonaws.com/nezuco%5B1%5D.jpg");
INSERT INTO administradores (id_administrador, apellidos, cedula, celular, contrasenia, email, nombre_usuario, nombres, url_imagen) VALUES (4, 'Idrovo', '0909090909', '0920014582', 'juanci1', 'juanidrovo@gmail.com', 'jsio420', 'Juan', "https://practicasjohnsiguenza.s3.us-east-2.amazonaws.com/demosslay%5B1%5D.jpg");
INSERT INTO administradores (id_administrador, apellidos, cedula, celular, contrasenia, email, nombre_usuario, nombres, url_imagen) VALUES (5, 'Gomez', '1010101010', '0987523010', 'paula0', 'pau@gmail.com', 'pauli6', 'Paula', "https://practicasjohnsiguenza.s3.us-east-2.amazonaws.com/nami.jpeg");
